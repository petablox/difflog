...
class ModrefScalability extends FunSuite {
  val name: String = "Modref"
  ...
  val soup_pre: Seq[Rule[FValue]] = Seq(
    ...
    Rule(22	,FValue(0.5, Token(22	)),modStatField(x0M,x1F), MputStatFldInst(x0M,x1F,x2V)),
    ...
    Rule(3	,FValue(0.5, Token(3	)),rMM(x0M,x1M), rMM(x2M,x0M),rMM(x2M,x3M),rMM(x3M,x1M)),
    Rule(4	,FValue(0.5, Token(4	)),rMM(x0M,x1M), rMM(x0M,x2M),rMM(x2M,x3M),rMM(x3M,x1M)),
    Rule(5	,FValue(0.5, Token(5	)),rMM(x0M,x1M), rMM(x0M,x2M),rMM(x1M,x2M)),
    Rule(6	,FValue(0.5, Token(6	)),rMM(x0M,x1M), refStatField(x0M,x2F),refStatField(x1M,x2F)),
    Rule(7	,FValue(0.5, Token(7	)),rMM(x0M,x1M), modStatField(x0M,x2F),modStatField(x1M,x2F)),
    Rule(8	,FValue(0.5, Token(8	)),rMM(x0M,x1M), MI(x0M,x2I),MI(x1M,x2I)),
    Rule(10	,FValue(0.5, Token(10	)),refStatField(x0M,x1F), modStatField(x2M,x1F),rMM(x0M,x2M)),
    ...
    Rule(14	,FValue(0.5, Token(14	)),refStatField(x0M,x1F), modStatField(x0M,x1F)),
    ...
    Rule(18	,FValue(0.5, Token(18	)),modStatField(x0M,x1F), refInstField(x0M,x2H,x1F)),
    Rule(19	,FValue(0.5, Token(19	)),modStatField(x0M,x1F), modInstField(x0M,x2H,x1F)),
    Rule(20	,FValue(0.5, Token(20	)),modStatField(x0M,x1F), MgetStatFldInst(x0M,x2V,x1F)),
    Rule(21	,FValue(0.5, Token(21	)),modStatField(x0M,x1F), refStatField(x0M,x1F)),
    Rule(23	,FValue(0.5, Token(23	)),refInstField(x0M,x1H,x2F), MputInstFldInst(x0M,x3V,x2F,x4V),VH(x3V,x1H)),
    Rule(24	,FValue(0.5, Token(24	)),refInstField(x0M,x1H,x2F), modInstField(x0M,x1H,x2F)),
    Rule(28	,FValue(0.5, Token(28	)),modInstField(x0M,x1H,x2F), refInstField(x0M,x1H,x2F)),
    Rule(30	,FValue(0.5, Token(30	)),modInstField(x0M,x1H,x2F), MgetInstFldInst(x0M,x3V,x4V,x2F),VH(x4V,x1H)),
  )

  val expected: Set[Any] = Set(1, 2, 9, 13, 17, 22, 25, 26, 27, 29)
  ...
  test(s"Scalability") {
    for (nrules <- Range(10, 31)) {
      ...
      val p = Program(s"ModrefScalability", soup)
