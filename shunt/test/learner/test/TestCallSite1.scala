...
class TestCallSite1 extends Problem {
  override val name: String = "CallSite1"

  val CSet : Set[Atom] = Range(0, 3).map(i => Atom(i)).toSet
  ...
  val MSet : Set[Atom] = Range(0, 2).map(i => Atom(i)).toSet
  val M : Domain = Domain("M", MSet)

  val ZSet : Set[Atom] = Range(0, 2).map(i => Atom(i)).toSet
  val Z : Domain = Domain("Z", ZSet)

  val FSet : Set[Atom] = Range(0, 2).map(i => Atom(i)).toSet
  ...
  val points_initialTuples: Set[DTuple] = Set((4, 0), (0, 6), (3, 1), (0, 2), (3, 7)).map{ case (a,b) => DTuple(Atom(a), Atom(b)) }
  val storeTuples : Set[DTuple] = Set((0, 1, 1), (5, 0, 5), (6, 0, 6), (2, 0, 4), (2, 1, 4), (3, 1, 4), (2, 0, 2), (4, 0, 0), (2, 0, 6),
    (4, 0, 6), (1, 1, 5), (1, 0, 2), (2, 1, 5), (7, 1, 6), (2, 1, 6)).map{ case (a,b,c) => DTuple(Atom(a), Atom(b), Atom(c)) }
  val loadTuples : Set[DTuple] = Set((5, 0, 4), (1, 0, 3), (5, 0, 1), (2, 0, 3), (2, 0, 4), (0, 1, 2), (7, 0, 5),
    (0, 1, 7), (3, 1, 4), (3, 1, 5), (6, 0, 0), (7, 1, 1), (6, 1, 3), (5, 1, 7)).map{ case (a,b,c) => DTuple(Atom(a), Atom(b), Atom(c)) }
  val invocationTuples : Set[DTuple] = Set((1, 1, 0, 1), (2, 4, 0, 1), (2, 4, 0, 0), (2, 0, 1, 1), (0, 6, 0, 1), (1, 1, 2, 1),
    (1, 3, 1, 1), (0, 7, 1, 1), (0, 2, 1, 1), (0, 0, 1, 0), (2, 7, 0, 1), (2, 0, 0, 0), (1, 2, 0, 1), (1, 5, 0, 1), (1, 5, 1, 1),
    (1, 4, 2, 0), (1, 2, 1, 1), (0, 5, 1, 0)).map{ case (a,b,c,d) =>
    DTuple(Atom(a), Atom(b), Atom(c), Atom(d)) }
  val actualTuples : Set[DTuple] = Set((0, 0, 6), (6, 0, 4)).map{ case (a,b,c) => DTuple(Atom(a), Atom(b), Atom(c)) }
  val formalTuples : Set[DTuple]  = Set((1, 0, 4), (1, 0, 6)).map{ case (a,b,c) => DTuple(Atom(a), Atom(b), Atom(c)) }
  val assignTuples : Set[DTuple] = Set((2, 7, 0, 6), (0, 3, 0, 7), (2, 4, 1, 2), (2, 3, 1, 2), (2, 7, 1, 4), (1, 4, 2, 3),
    (0, 4, 2, 0), (2, 1, 2, 4), (2, 5, 1, 6), (1, 5, 1, 6), (2, 3, 1, 0)).map{ case (a,b,c,d) => DTuple(Atom(a), Atom(b), Atom(c), Atom(d)) }

  val pointsto: Relation = Relation("pointsto", C, V, H)
  val heappointsto: Relation = Relation("heappointsto", H, F, H)

  val pointstoTuples : Set[DTuple] = Set((1, 1, 7), (2, 7, 1), (2, 7, 2), (0, 5, 7), (1, 4, 2), (0, 2, 1), (0, 5, 1), (1, 7, 2),
    (2, 7, 6), (1, 7, 0), (1, 2, 0), (1, 7, 6), (0, 2, 7), (1, 2, 2), (0, 3, 2), (0, 7, 2), (0, 7, 0), (2, 5, 7), (0, 4, 2),
    (1, 3, 7), (1, 2, 6), (1, 5, 7), (0, 4, 0), (1, 5, 1), (0, 1, 0), (0, 4, 6), (1, 2, 7), (2, 3, 6), (1, 3, 1), (2, 3, 0),
    (2, 4, 0), (2, 3, 2), (2, 4, 2), (2, 1, 7), (2, 4, 6), (0, 3, 1), (1, 4, 0), (0, 3, 7), (1, 1, 0), (2, 1, 1), (1, 1, 2),
    (1, 4, 7), (1, 4, 1), (0, 3, 6), (0, 5, 6), (1, 1, 6), (0, 5, 0), (0, 2, 0), (0, 5, 2), (1, 7, 1), (2, 7, 7), (0, 2, 2),
    (0, 1, 2), (1, 7, 7), (2, 5, 2), (0, 7, 7), (2, 5, 0), (0, 2, 6), (2, 5, 6), (0, 7, 6), (0, 4, 1), (1, 3, 6), (0, 7, 1),
    (1, 5, 6), (0, 4, 7), (1, 0, 2), (1, 5, 0), (0, 1, 1), (1, 3, 2), (1, 2, 1), (1, 5, 2), (2, 3, 7), (1, 3, 0), (2, 4, 1),
    (2, 3, 1), (0, 0, 6), (0, 1, 7), (2, 1, 6), (2, 4, 7), (0, 0, 2), (0, 3, 0), (2, 1, 2), (0, 1, 6), (1, 1, 1), (2, 5, 1),
    (2, 7, 0), (2, 1, 0), (1, 4, 6)).map{ case (a,b,c) => DTuple(Atom(a), Atom(b), Atom(c)) }
  val heappointstoTuples : Set[DTuple] = Set((7, 1, 0), (0, 1, 1), (1, 1, 7), (0, 1, 2), (6, 0, 1), (1, 1, 6), (1, 0, 1),
    (7, 1, 2), (1, 0, 6), (7, 1, 1), (1, 0, 7), (6, 0, 2), (0, 0, 7), (0, 1, 6), (7, 0, 0), (7, 1, 7), (2, 0, 7), (0, 0, 6),
    (6, 1, 2), (0, 1, 7), (7, 1, 6), (2, 0, 6), (1, 0, 0), (6, 0, 7), (2, 0, 1), (6, 1, 0), (2, 1, 6), (6, 0, 6), (2, 0, 0),
    (7, 0, 7), (2, 1, 7), (0, 0, 2), (6, 1, 6), (2, 0, 2), (0, 0, 1), (7, 0, 1), (6, 1, 7), (7, 0, 6), (0, 0, 0), (7, 0, 2),
    (2, 1, 2), (1, 1, 1), (0, 1, 0), (1, 1, 0), (2, 1, 0), (6, 0, 0), (2, 1, 1), (1, 1, 2),
    (1, 0, 2), (6, 1, 1)).map{ case (a,b,c) => DTuple(Atom(a), Atom(b), Atom(c)) }
  ...
  val soup_pre : Set[Rule[FValue]] = Set(
    ...
    Rule(6,FValue(0.5, Token(6)),pointsto(x3C,x4V,x1H), assign(x2C,x0V,x3C,x4V),points_initial(x0V,x1H)),
    ...
    Rule(10,FValue(0.5, Token(10)),pointsto(x4C,x3V,x1H), assign(x2C,x3V,x4C,x0V),points_initial(x0V,x1H)),
    ...
    Rule(13,FValue(0.5, Token(13)),pointsto(x3C,x2V,x0H), actual(x0H,x1Z,x2V),assign(x3C,x2V,x4C,x5V)),
    ...
    Rule(20,FValue(0.5, Token(20)),pointsto(x3C,x0V,x4H), load(x0V,x1F,x2V),pointsto(x3C,x2V,x4H)),
    ...
    Rule(24,FValue(0.5, Token(24)),pointsto(x0C,x4V,x5H), invocation(x0C,x1H,x2C,x3M),pointsto(x2C,x4V,x5H)),
    Rule(25,FValue(0.5, Token(25)),pointsto(x0C,x4V,x5H), assign(x0C,x1V,x2C,x3V),pointsto(x2C,x4V,x5H)),
    Rule(26,FValue(0.5, Token(26)),pointsto(x0C,x1V,x5H), assign(x0C,x1V,x2C,x3V),pointsto(x0C,x4V,x5H)),
    Rule(27,FValue(0.5, Token(27)),pointsto(x0C,x3V,x5H), assign(x0C,x1V,x2C,x3V),pointsto(x0C,x4V,x5H)),
    Rule(28,FValue(0.5, Token(28)),pointsto(x2C,x1V,x5H), assign(x0C,x1V,x2C,x3V),pointsto(x0C,x4V,x5H)),
    Rule(29,FValue(0.5, Token(29)),pointsto(x0C,x1V,x5H), assign(x0C,x1V,x2C,x3V),pointsto(x4C,x1V,x5H)),
    Rule(30,FValue(0.5, Token(30)),pointsto(x0C,x3V,x5H), assign(x0C,x1V,x2C,x3V),pointsto(x4C,x1V,x5H)),
    Rule(31,FValue(0.5, Token(31)),pointsto(x2C,x1V,x5H), assign(x0C,x1V,x2C,x3V),pointsto(x4C,x1V,x5H)),
    Rule(32,FValue(0.5, Token(32)),pointsto(x0C,x1V,x5H), assign(x0C,x1V,x2C,x3V),pointsto(x2C,x4V,x5H)),
    Rule(33,FValue(0.5, Token(33)),pointsto(x0C,x3V,x5H), assign(x0C,x1V,x2C,x3V),pointsto(x2C,x4V,x5H)),
    Rule(34,FValue(0.5, Token(34)),pointsto(x2C,x1V,x5H), assign(x0C,x1V,x2C,x3V),pointsto(x2C,x4V,x5H)),
    Rule(35,FValue(0.5, Token(35)),pointsto(x2C,x3V,x5H), assign(x0C,x1V,x2C,x3V),pointsto(x2C,x4V,x5H)),
    ...
    Rule(40,FValue(0.5, Token(40)),pointsto(x4C,x1V,x5H), assign(x0C,x1V,x2C,x3V),pointsto(x4C,x3V,x5H)),
    Rule(41,FValue(0.5, Token(41)),pointsto(x3C,x4V,x2H), heappointsto(x0H,x1F,x2H),pointsto(x3C,x4V,x0H)),
    Rule(42,FValue(0.5, Token(42)),pointsto(x3C,x4V,x0H), heappointsto(x0H,x1F,x2H),pointsto(x3C,x4V,x2H)),
    Rule(43,FValue(0.5, Token(43)),pointsto(x0C,x1V,x4H), pointsto(x0C,x1V,x2H),pointsto(x0C,x3V,x4H)),
    Rule(44,FValue(0.5, Token(44)),pointsto(x0C,x1V,x4H), pointsto(x0C,x1V,x2H),pointsto(x3C,x1V,x4H)),
    Rule(45,FValue(0.5, Token(45)),pointsto(x0C,x4V,x2H), pointsto(x0C,x1V,x2H),pointsto(x3C,x4V,x2H)),
    ...
    Rule(89,FValue(0.5, Token(89)),heappointsto(x4H,x1F,x3H), heappointsto(x0H,x1F,x3H),heappointsto(x3H,x1F,x4H)),
