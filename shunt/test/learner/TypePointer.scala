...
class TypePointer extends Problem {
  ...
  Rule(2,FValue(0.5, Token(2)),pointsto(x1T,x0V,x3H), enclosing_type(x0V,x1T),pointsto(x1T,x2V,x3H)),
  Rule(3,FValue(0.5, Token(3)),pointsto(x2T,x0V,x1H), assign(x2T,x0V,x3T,x4V),points_initial(x0V,x1H)),
  Rule(4,FValue(0.5, Token(4)),pointsto(x2T,x4V,x1H), assign(x2T,x0V,x3T,x4V),points_initial(x0V,x1H)),
  Rule(5,FValue(0.5, Token(5)),pointsto(x3T,x0V,x1H), assign(x2T,x0V,x3T,x4V),points_initial(x0V,x1H)),
  Rule(6,FValue(0.5, Token(6)),pointsto(x2T,x0V,x1H), assign(x2T,x3V,x4T,x0V),points_initial(x0V,x1H)),
  Rule(7,FValue(0.5, Token(7)),pointsto(x2T,x3V,x1H), assign(x2T,x3V,x4T,x0V),points_initial(x0V,x1H)),
  Rule(8,FValue(0.5, Token(8)),pointsto(x4T,x3V,x1H), assign(x2T,x3V,x4T,x0V),points_initial(x0V,x1H)),
  Rule(9,FValue(0.5, Token(9)),pointsto(x2T,x0V,x1H), points_initial(x0V,x1H),pointsto(x2T,x0V,x3H)),
  Rule(10,FValue(0.5, Token(10)),pointsto(x2T,x0V,x1H), points_initial(x0V,x1H),pointsto(x2T,x3V,x1H)),
  Rule(11,FValue(0.5, Token(11)),pointsto(x2T,x1V,x0H), assign(x2T,x1V,x3T,x4V),receiver_formal(x0H,x1V)),
  Rule(12,FValue(0.5, Token(12)),pointsto(x2T,x4V,x0H), assign(x2T,x1V,x3T,x4V),receiver_formal(x0H,x1V)),
  ...
  Rule(15,FValue(0.5, Token(15)),pointsto(x3T,x0V,x4H), pointsto(x3T,x2V,x4H),store(x0V,x1F,x2V)),
  ...
  Rule(18,FValue(0.5, Token(18)),pointsto(x0T,x1V,x5H), assign(x0T,x1V,x2T,x3V),pointsto(x4T,x1V,x5H)),
  ...
  Rule(21,FValue(0.5, Token(21)),pointsto(x0T,x4V,x5H), assign(x0T,x1V,x2T,x3V),pointsto(x2T,x4V,x5H)),
  Rule(22,FValue(0.5, Token(22)),pointsto(x2T,x1V,x5H), assign(x0T,x1V,x2T,x3V),pointsto(x2T,x4V,x5H)),
  Rule(23,FValue(0.5, Token(23)),pointsto(x0T,x1V,x5H), assign(x0T,x1V,x2T,x3V),pointsto(x4T,x3V,x5H)),
  ...
  Rule(26,FValue(0.5, Token(26)),pointsto(x4T,x1V,x5H), assign(x0T,x1V,x2T,x3V),pointsto(x4T,x3V,x5H)),
  Rule(27,FValue(0.5, Token(27)),pointsto(x3T,x4V,x2H), heappointsto(x0H,x1F,x2H),pointsto(x3T,x4V,x0H)),
  Rule(28,FValue(0.5, Token(28)),pointsto(x0T,x1V,x4H), pointsto(x0T,x1V,x2H),pointsto(x0T,x3V,x4H)),
  Rule(29,FValue(0.5, Token(29)),pointsto(x0T,x1V,x4H), pointsto(x0T,x1V,x2H),pointsto(x3T,x1V,x4H)),
  Rule(30,FValue(0.5, Token(30)),pointsto(x0T,x1V,x2H), heappointsto(x5H,x4F,x2H),pointsto(x0T,x3V,x5H),store(x3V,x4F,x1V)),
  ...
  Rule(33,FValue(0.5, Token(33)),heappointsto(x0H,x1F,x4H), heappointsto(x0H,x1F,x2H),heappointsto(x0H,x3F,x4H)),
  Rule(34,FValue(0.5, Token(34)),heappointsto(x0H,x4F,x2H), heappointsto(x0H,x1F,x2H),heappointsto(x3H,x4F,x0H)),
  Rule(35,FValue(0.5, Token(35)),heappointsto(x3H,x1F,x2H), heappointsto(x0H,x1F,x2H),heappointsto(x3H,x4F,x0H)),
