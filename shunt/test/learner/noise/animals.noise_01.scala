...
class Genanimals_1 extends Problem {
	...
	val fishTuples = Set(4,5,6,7,(1, 10),(12, 16)).map { case (x0) => DTuple(Atom(x0)) }
	...
	val birdTuples = Set(13,14,15,(4, 4),(4, 14),(18, 11)).map { case (x0) => DTuple(Atom(x0)) }
