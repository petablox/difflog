...
class CallSite2 extends Problem {
  ...
  override val soup : Set[Rule[FValue]] = Set(
    ...
    Rule(6	,FValue(0.5, Token(6	)),pointsto(x3C,x5C,x0V,x1H), invocation(x2C,x3C,x1H,x4C,x5C,x6M),points_initial(x0V,x1H)),
    Rule(7	,FValue(0.5, Token(7	)),pointsto(x4C,x2C,x0V,x1H), invocation(x2C,x3C,x1H,x4C,x5C,x6M),points_initial(x0V,x1H)),
    ...
    Rule(17	,FValue(0.5, Token(17	)),pointsto(x6C,x3C,x4V,x1H), assign(x2C,x3C,x4V,x5C,x6C,x0V),points_initial(x0V,x1H)),
    Rule(18	,FValue(0.5, Token(18	)),pointsto(x2C,x3C,x0V,x1H), points_initial(x0V,x1H),pointsto(x2C,x3C,x0V,x4H)),
    Rule(19	,FValue(0.5, Token(19	)),pointsto(x3C,x2C,x0V,x1H), points_initial(x0V,x1H),pointsto(x2C,x3C,x0V,x4H)),
    Rule(20	,FValue(0.5, Token(20	)),pointsto(x3C,x2C,x0V,x4H), points_initial(x0V,x1H),pointsto(x2C,x3C,x0V,x4H)),
    Rule(21	,FValue(0.5, Token(21	)),pointsto(x2C,x3C,x0V,x1H), points_initial(x0V,x1H),pointsto(x2C,x3C,x4V,x1H)),
    ...
    Rule(27	,FValue(0.5, Token(27	)),pointsto(x3C,x4C,x2V,x5H), pointsto(x3C,x4C,x0V,x5H),store(x0V,x1F,x2V)),
    Rule(28	,FValue(0.5, Token(28	)),pointsto(x3C,x4C,x2V,x5H), load(x0V,x1F,x2V),pointsto(x3C,x4C,x0V,x5H)),
    Rule(29	,FValue(0.5, Token(29	)),pointsto(x4C,x3C,x0V,x5H), pointsto(x3C,x4C,x0V,x5H),store(x0V,x1F,x2V)),
    Rule(30	,FValue(0.5, Token(30	)),pointsto(x4C,x3C,x0V,x5H), load(x0V,x1F,x2V),pointsto(x3C,x4C,x0V,x5H)),
    Rule(31	,FValue(0.5, Token(31	)),pointsto(x0C,x1C,x7V,x8H), invocation(x0C,x1C,x2H,x3C,x4C,x5M),pointsto(x3C,x6C,x7V,x8H)),
    Rule(32	,FValue(0.5, Token(32	)),pointsto(x0C,x1C,x7V,x8H), assign(x0C,x1C,x2V,x3C,x4C,x5V),pointsto(x3C,x6C,x7V,x8H)),
    Rule(33	,FValue(0.5, Token(33	)),pointsto(x0C,x1C,x7V,x8H), invocation(x0C,x1C,x2H,x3C,x4C,x5M),pointsto(x6C,x4C,x7V,x8H)),
    Rule(34	,FValue(0.5, Token(34	)),pointsto(x0C,x1C,x7V,x8H), assign(x0C,x1C,x2V,x3C,x4C,x5V),pointsto(x6C,x4C,x7V,x8H)),
    Rule(35	,FValue(0.5, Token(35	)),pointsto(x0C,x1C,x2V,x8H), assign(x0C,x1C,x2V,x3C,x4C,x5V),pointsto(x0C,x6C,x7V,x8H)),
    ...
    Rule(39	,FValue(0.5, Token(39	)),pointsto(x0C,x1C,x2V,x8H), assign(x0C,x1C,x2V,x3C,x4C,x5V),pointsto(x6C,x7C,x2V,x8H)),
    Rule(40	,FValue(0.5, Token(40	)),pointsto(x0C,x1C,x2V,x8H), assign(x0C,x1C,x2V,x3C,x4C,x5V),pointsto(x3C,x6C,x7V,x8H)),
    Rule(41	,FValue(0.5, Token(41	)),pointsto(x0C,x1C,x5V,x8H), assign(x0C,x1C,x2V,x3C,x4C,x5V),pointsto(x3C,x6C,x7V,x8H)),
    Rule(42	,FValue(0.5, Token(42	)),pointsto(x0C,x3C,x2V,x8H), assign(x0C,x1C,x2V,x3C,x4C,x5V),pointsto(x3C,x6C,x7V,x8H)),
    ...
    Rule(47	,FValue(0.5, Token(47	)),pointsto(x6C,x1C,x2V,x8H), assign(x0C,x1C,x2V,x3C,x4C,x5V),pointsto(x3C,x6C,x7V,x8H)),
    Rule(48	,FValue(0.5, Token(48	)),pointsto(x0C,x1C,x2V,x8H), assign(x0C,x1C,x2V,x3C,x4C,x5V),pointsto(x6C,x3C,x7V,x8H)),
    Rule(49	,FValue(0.5, Token(49	)),pointsto(x0C,x1C,x2V,x8H), assign(x0C,x1C,x2V,x3C,x4C,x5V),pointsto(x4C,x6C,x7V,x8H)),
    Rule(50	,FValue(0.5, Token(50	)),pointsto(x0C,x1C,x2V,x8H), assign(x0C,x1C,x2V,x3C,x4C,x5V),pointsto(x6C,x4C,x7V,x8H)),
    Rule(51	,FValue(0.5, Token(51	)),pointsto(x0C,x1C,x5V,x8H), assign(x0C,x1C,x2V,x3C,x4C,x5V),pointsto(x6C,x4C,x7V,x8H)),
    Rule(52	,FValue(0.5, Token(52	)),pointsto(x0C,x3C,x2V,x8H), assign(x0C,x1C,x2V,x3C,x4C,x5V),pointsto(x6C,x4C,x7V,x8H)),
    Rule(53	,FValue(0.5, Token(53	)),pointsto(x0C,x4C,x2V,x8H), assign(x0C,x1C,x2V,x3C,x4C,x5V),pointsto(x6C,x4C,x7V,x8H)),
    Rule(54	,FValue(0.5, Token(54	)),pointsto(x0C,x6C,x2V,x8H), assign(x0C,x1C,x2V,x3C,x4C,x5V),pointsto(x6C,x4C,x7V,x8H)),
    Rule(55	,FValue(0.5, Token(55	)),pointsto(x3C,x1C,x2V,x8H), assign(x0C,x1C,x2V,x3C,x4C,x5V),pointsto(x6C,x4C,x7V,x8H)),
    Rule(56	,FValue(0.5, Token(56	)),pointsto(x4C,x1C,x2V,x8H), assign(x0C,x1C,x2V,x3C,x4C,x5V),pointsto(x6C,x4C,x7V,x8H)),
    ...
    Rule(60	,FValue(0.5, Token(60	)),pointsto(x0C,x3C,x2V,x8H), assign(x0C,x1C,x2V,x3C,x4C,x5V),pointsto(x6C,x7C,x5V,x8H)),
    Rule(61	,FValue(0.5, Token(61	)),pointsto(x0C,x4C,x2V,x8H), assign(x0C,x1C,x2V,x3C,x4C,x5V),pointsto(x6C,x7C,x5V,x8H)),
    Rule(62	,FValue(0.5, Token(62	)),pointsto(x0C,x6C,x2V,x8H), assign(x0C,x1C,x2V,x3C,x4C,x5V),pointsto(x6C,x7C,x5V,x8H)),
    Rule(63	,FValue(0.5, Token(63	)),pointsto(x0C,x7C,x2V,x8H), assign(x0C,x1C,x2V,x3C,x4C,x5V),pointsto(x6C,x7C,x5V,x8H)),
    Rule(64	,FValue(0.5, Token(64	)),pointsto(x3C,x1C,x2V,x8H), assign(x0C,x1C,x2V,x3C,x4C,x5V),pointsto(x6C,x7C,x5V,x8H)),
    Rule(65	,FValue(0.5, Token(65	)),pointsto(x4C,x1C,x2V,x8H), assign(x0C,x1C,x2V,x3C,x4C,x5V),pointsto(x6C,x7C,x5V,x8H)),
    Rule(66	,FValue(0.5, Token(66	)),pointsto(x6C,x1C,x2V,x8H), assign(x0C,x1C,x2V,x3C,x4C,x5V),pointsto(x6C,x7C,x5V,x8H)),
    Rule(67	,FValue(0.5, Token(67	)),pointsto(x7C,x1C,x2V,x8H), assign(x0C,x1C,x2V,x3C,x4C,x5V),pointsto(x6C,x7C,x5V,x8H)),
    Rule(68	,FValue(0.5, Token(68	)),pointsto(x3C,x4C,x5V,x2H), heappointsto(x0H,x1F,x2H),pointsto(x3C,x4C,x5V,x0H)),
    Rule(69	,FValue(0.5, Token(69	)),pointsto(x4C,x3C,x5V,x2H), heappointsto(x0H,x1F,x2H),pointsto(x3C,x4C,x5V,x0H)),
    ...
    Rule(73	,FValue(0.5, Token(73	)),pointsto(x0C,x1C,x2V,x6H), pointsto(x0C,x1C,x2V,x3H),pointsto(x4C,x1C,x5V,x6H)),
    Rule(74	,FValue(0.5, Token(74	)),pointsto(x0C,x1C,x2V,x6H), pointsto(x0C,x1C,x2V,x3H),pointsto(x4C,x5C,x2V,x6H)),
    Rule(75	,FValue(0.5, Token(75	)),pointsto(x0C,x1C,x2V,x3H), assign(x0C,x1C,x2V,x4C,x5C,x6V),pointsto(x4C,x5C,x6V,x3H)),
    Rule(76	,FValue(0.5, Token(76	)),pointsto(x0C,x1C,x2V,x3H), heappointsto(x6H,x5F,x3H),pointsto(x0C,x1C,x4V,x6H),store(x4V,x5F,x2V)),
    Rule(77	,FValue(0.5, Token(77	)),pointsto(x0C,x1C,x2V,x3H), heappointsto(x6H,x5F,x3H),load(x4V,x5F,x2V),pointsto(x0C,x1C,x4V,x6H)),
    Rule(78	,FValue(0.5, Token(78	)),heappointsto(x3H,x2F,x1H), heappointsto(x1H,x2F,x3H),points_initial(x0V,x1H)),
    Rule(79	,FValue(0.5, Token(79	)),heappointsto(x4H,x3F,x0H), actual(x0H,x1Z,x2V),heappointsto(x0H,x3F,x4H)),
    ...
    Rule(83	,FValue(0.5, Token(83	)),heappointsto(x2H,x1F,x4H), heappointsto(x0H,x1F,x2H),heappointsto(x0H,x3F,x4H)),
    Rule(84	,FValue(0.5, Token(84	)),heappointsto(x2H,x3F,x4H), heappointsto(x0H,x1F,x2H),heappointsto(x0H,x3F,x4H)),
    ...
    Rule(94	,FValue(0.5, Token(94	)),heappointsto(x0H,x1F,x3H), heappointsto(x0H,x1F,x2H),heappointsto(x3H,x1F,x4H)),
    Rule(95	,FValue(0.5, Token(95	)),heappointsto(x0H,x1F,x4H), heappointsto(x0H,x1F,x2H),heappointsto(x3H,x1F,x4H)),
    Rule(96	,FValue(0.5, Token(96	)),heappointsto(x2H,x1F,x3H), heappointsto(x0H,x1F,x2H),heappointsto(x3H,x1F,x4H)),
    Rule(97	,FValue(0.5, Token(97	)),heappointsto(x2H,x1F,x4H), heappointsto(x0H,x1F,x2H),heappointsto(x3H,x1F,x4H)),
    Rule(98	,FValue(0.5, Token(98	)),heappointsto(x0H,x1F,x3H), heappointsto(x0H,x1F,x2H),heappointsto(x3H,x4F,x2H)),
    Rule(99	,FValue(0.5, Token(99	)),heappointsto(x0H,x4F,x2H), heappointsto(x0H,x1F,x2H),heappointsto(x3H,x4F,x2H)),
    Rule(100	,FValue(0.5, Token(100	)),heappointsto(x0H,x4F,x3H), heappointsto(x0H,x1F,x2H),heappointsto(x3H,x4F,x2H)),
