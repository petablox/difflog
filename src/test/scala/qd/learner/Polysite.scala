...
class Polysite extends Problem {
  ...
  override val soup : Set[Rule[FValue]] = Set(
    ...
    Rule(36,FValue(0.5, Token(36)),virtI(x0I), CICM(x3C,x4I,x2M),Mneq(x2M,x1M),insvIM(x0I,x1M)),
    Rule(37,FValue(0.5, Token(37)),virtI(x0I), CICM(x3C,x4I,x2M),Mneq(x2M,x1M),virtIM(x0I,x1M)),
    Rule(38,FValue(0.5, Token(38)),virtI(x0I), CICM(x3C,x2I,x4M),insvIM(x0I,x1M),insvIM(x2I,x1M)),
    ...
    Rule(75,FValue(0.5, Token(75)),virtI(x2I), CICM(x3C,x2I,x0M),Mneq(x0M,x1M),virtIM(x2I,x0M)),
    Rule(76,FValue(0.5, Token(76)),virtI(x0I), CICM(x3C,x2I,x1M),insvIM(x0I,x1M),insvIM(x2I,x1M)),
    Rule(77,FValue(0.5, Token(77)),virtI(x0I), CICM(x3C,x2I,x1M),insvIM(x0I,x1M),virtIM(x2I,x1M)),
    Rule(78,FValue(0.5, Token(78)),virtI(x0I), CICM(x3C,x2I,x1M),insvIM(x2I,x1M),virtIM(x0I,x1M)),
    Rule(79,FValue(0.5, Token(79)),virtI(x0I), CICM(x3C,x2I,x1M),virtIM(x0I,x1M),virtIM(x2I,x1M)),
    ...
    Rule(111,FValue(0.5, Token(111)),polySite(x3I), CICM(x2C,x3I,x0M),Mneq(x0M,x1M),virtIM(x3I,x4M)),
    Rule(112,FValue(0.5, Token(112)),polySite(x3I), CICM(x2C,x3I,x0M),Mneq(x0M,x1M),virtI(x3I)),
    Rule(113,FValue(0.5, Token(113)),polySite(x0I), CICM(x3C,x4I,x2M),Mneq(x1M,x2M),insvIM(x0I,x1M)),
    Rule(114,FValue(0.5, Token(114)),polySite(x0I), CICM(x3C,x4I,x2M),Mneq(x1M,x2M),virtIM(x0I,x1M)),
    Rule(115,FValue(0.5, Token(115)),polySite(x0I), CICM(x3C,x4I,x2M),Mneq(x2M,x1M),insvIM(x0I,x1M)),
    Rule(116,FValue(0.5, Token(116)),polySite(x0I), CICM(x3C,x4I,x2M),Mneq(x2M,x1M),virtIM(x0I,x1M)),
    ...
    Rule(144,FValue(0.5, Token(144)),polySite(x4I), CICM(x3C,x4I,x2M),Mneq(x0M,x0M),Mneq(x2M,x0M)),
    Rule(145,FValue(0.5, Token(145)),polySite(x4I), CICM(x3C,x4I,x2M),Mneq(x1M,x2M),insvIM(x4I,x1M)),
    Rule(146,FValue(0.5, Token(146)),polySite(x4I), CICM(x3C,x4I,x2M),Mneq(x1M,x2M),virtIM(x4I,x1M)),
    Rule(147,FValue(0.5, Token(147)),polySite(x4I), CICM(x3C,x4I,x2M),Mneq(x2M,x1M),insvIM(x4I,x1M)),
    Rule(148,FValue(0.5, Token(148)),polySite(x4I), CICM(x3C,x4I,x2M),Mneq(x2M,x1M),virtIM(x4I,x1M)),
    Rule(149,FValue(0.5, Token(149)),polySite(x2I), Mneq(x0M,x0M),insvIM(x2I,x0M),virtIM(x2I,x3M)),
    Rule(150,FValue(0.5, Token(150)),polySite(x2I), Mneq(x0M,x0M),insvIM(x2I,x3M),virtIM(x2I,x0M)),
    Rule(151,FValue(0.5, Token(151)),polySite(x2I), CICM(x3C,x2I,x4M),Mneq(x0M,x0M),insvIM(x2I,x0M)),
    Rule(152,FValue(0.5, Token(152)),polySite(x2I), CICM(x3C,x2I,x4M),Mneq(x0M,x0M),virtIM(x2I,x0M)),
    Rule(153,FValue(0.5, Token(153)),polySite(x2I), CICM(x3C,x2I,x0M),Mneq(x0M,x1M),insvIM(x2I,x0M)),
    ...
    Rule(168,FValue(0.5, Token(168)),insvIM(x3I,x1M), insvIM(x0I,x2M),virtIM(x0I,x1M),virtIM(x3I,x2M)),
    Rule(169,FValue(0.5, Token(169)),insvIM(x3I,x1M), insvIM(x3I,x2M),virtIM(x0I,x1M),virtIM(x0I,x2M)),
    Rule(170,FValue(0.5, Token(170)),insvIM(x3I,x1M), virtIM(x0I,x1M),virtIM(x0I,x2M),virtIM(x3I,x2M)),
    Rule(171,FValue(0.5, Token(171)),insvIM(x3I,x0M), Mneq(x0M,x1M),Mneq(x2M,x0M),insvIM(x3I,x2M)),
    Rule(172,FValue(0.5, Token(172)),insvIM(x3I,x0M), Mneq(x0M,x1M),Mneq(x2M,x0M),virtIM(x3I,x2M)),
    Rule(173,FValue(0.5, Token(173)),insvIM(x3I,x1M), Mneq(x0M,x1M),Mneq(x2M,x0M),insvIM(x3I,x2M)),
    Rule(174,FValue(0.5, Token(174)),insvIM(x3I,x1M), Mneq(x0M,x1M),Mneq(x2M,x0M),virtIM(x3I,x2M)),
    Rule(175,FValue(0.5, Token(175)),insvIM(x3I,x0M), Mneq(x0M,x1M),Mneq(x1M,x2M),insvIM(x3I,x2M)),
