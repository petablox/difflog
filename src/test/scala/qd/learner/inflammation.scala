...
inflamation -> (Instance(inflamation) ++ inflamationTuples.map(t => t -> One).toMap),
	...
	val soup = Set(
		...
		Rule(12, Value(0.5, Token(12)), inflamation(x0P),burning_urethra(x0P),not_burning_urethra(x0P)),
		Rule(13, Value(0.5, Token(13)), inflamation(x0P),not_burning_urethra(x0P),not_nausea(x0P)),
		Rule(14, Value(0.5, Token(14)), inflamation(x0P),not_burning_urethra(x0P),not_lumbar_pain(x0P)),
		Rule(15, Value(0.5, Token(15)), inflamation(x0P),not_burning_urethra(x0P),not_urine_pushing(x0P)),
		Rule(16, Value(0.5, Token(16)), inflamation(x0P),nausea(x0P),not_burning_urethra(x0P)),
		...
		Rule(27, Value(0.5, Token(27)), inflamation(x0P),micturition_pain(x0P),urine_pushing(x0P)),
		Rule(28, Value(0.5, Token(28)), inflamation(x0P),burning_urethra(x0P),urine_pushing(x0P)),
		Rule(29, Value(0.5, Token(29)), inflamation(x0P),not_nausea(x0P),urine_pushing(x0P)),
		...
		Rule(55, Value(0.5, Token(55)), inflamation(x0P),not_nausea(x0P),not_urine_pushing(x0P)),
		...
		Rule(68, Value(0.5, Token(68)), inflamation(x0P),micturition_pain(x0P),not_urine_pushing(x0P)),
		Rule(69, Value(0.5, Token(69)), inflamation(x0P),burning_urethra(x0P),not_urine_pushing(x0P)),
		Rule(70, Value(0.5, Token(70)), inflamation(x0P),not_nausea(x0P),not_urine_pushing(x0P)),
		...
		Rule(74, Value(0.5, Token(74)), inflamation(x0P),nausea(x0P),not_micturition_pain(x0P)),
	...
	val soupProg = Program("inflammationSoup", soup)
