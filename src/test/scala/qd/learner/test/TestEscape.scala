...
class TestEscape extends Problem {
  ...
  override val soup: Set[Rule] = Set(
		Rule(1, Value(0.990000, Token(1)), rHH(x0,x2),HFH(x0,x2)),
		Rule(2, Value(0.243132, Token(2)), rHH(x3,x2),HFH(x0,x2),rHH(x3,x0)),
		Rule(3, Value(0.990000, Token(3)), rHH(x0,x3),HFH(x0,x2),rHH(x2,x3)),
		Rule(4, Value(0.221704, Token(4)), rHH(x2,x1),rHH(x0,x1),rHH(x2,x0)),
		Rule(5, Value(0.010000, Token(5)), rMH(x0,x1),rRH(x0,x1)),
		Rule(6, Value(0.990000, Token(6)), rMH(x2,x1),MmethArg(x2,x0),VH(x0,x1)),
		Rule(7, Value(0.010000, Token(7)), rMH(x2,x1),MmethRet(x2,x0),VH(x0,x1)),
		Rule(8, Value(0.010000, Token(8)), rMH(x2,x1),rMH(x0,x1),rRH(x2,x1)),
		Rule(9, Value(0.010000, Token(9)), rMH(x2,x1),rHH(x0,x1),rRH(x2,x1)),
		Rule(10, Value(0.010000, Token(10)), rMH(x2,x1),VH(x0,x1),rRH(x2,x1)),
		Rule(11, Value(0.990000, Token(11)), rMH(x3,x2),HFH(x0,x2),rRH(x3,x0)),
		Rule(12, Value(0.990000, Token(12)), rMH(x3,x2),HFH(x0,x2),rMH(x3,x0)),
		Rule(13, Value(0.010000, Token(13)), rMH(x0,x1),rHH(x1,x2),rRH(x0,x1)),
		Rule(14, Value(0.990000, Token(14)), rMH(x0,x2),rHH(x1,x2),rRH(x0,x1)),
		Rule(15, Value(0.094296, Token(15)), rMH(x0,x2),rHH(x1,x2),rMH(x0,x1)),
		Rule(16, Value(0.010000, Token(16)), rRH(x0,x1),rMH(x0,x1)),
		Rule(17, Value(0.010000, Token(17)), rRH(x2,x1),MmethArg(x2,x0),VH(x0,x1)),
		Rule(18, Value(0.990000, Token(18)), rRH(x2,x1),MmethRet(x2,x0),VH(x0,x1)),
		Rule(19, Value(0.010000, Token(19)), rRH(x2,x1),rMH(x2,x1),rRH(x0,x1)),
		Rule(20, Value(0.010000, Token(20)), rRH(x2,x1),rHH(x0,x1),rMH(x2,x1)),
		Rule(21, Value(0.010000, Token(21)), rRH(x2,x1),VH(x0,x1),rMH(x2,x1)),
		Rule(22, Value(0.990000, Token(22)), rRH(x3,x2),HFH(x0,x2),rRH(x3,x0)),
		Rule(23, Value(0.990000, Token(23)), rRH(x3,x2),HFH(x0,x2),rMH(x3,x0)),
		Rule(24, Value(0.010000, Token(24)), rRH(x0,x1),rHH(x1,x2),rMH(x0,x1)),
		Rule(25, Value(0.061999, Token(25)), rRH(x0,x2),rHH(x1,x2),rRH(x0,x1)),
		Rule(26, Value(0.365846, Token(26)), rRH(x0,x2),rHH(x1,x2),rMH(x0,x1)),
  )
