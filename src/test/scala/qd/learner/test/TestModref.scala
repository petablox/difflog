...
class TestModref extends Problem {
  ...
  val soup_pre: Set[Rule] = Set(
		...
		Rule(4, Value(0.990000, Token(4)), rMM(x0M,x1M),rMM(x0M,x2M),rMM(x2M,x3M),rMM(x3M,x1M)),
		Rule(5, Value(0.010000, Token(5)), rMM(x0M,x1M),rMM(x0M,x2M),rMM(x1M,x2M)),
		Rule(6, Value(0.010000, Token(6)), rMM(x0M,x1M),refStatField(x0M,x2F),refStatField(x1M,x2F)),
		Rule(7, Value(0.010000, Token(7)), rMM(x0M,x1M),modStatField(x0M,x2F),modStatField(x1M,x2F)),
		Rule(8, Value(0.010000, Token(8)), rMM(x0M,x1M),MI(x0M,x2I),MI(x1M,x2I)),
		Rule(9, Value(0.907023, Token(9)), refStatField(x0M,x1F),rMM(x0M,x2M),refStatField(x2M,x1F)),
		Rule(10, Value(0.112560, Token(10)), refStatField(x0M,x1F),modStatField(x2M,x1F),rMM(x0M,x2M)),
		Rule(11, Value(0.010000, Token(11)), refStatField(x0M,x1F),refInstField(x0M,x2H,x1F)),
		Rule(12, Value(0.010000, Token(12)), refStatField(x0M,x1F),modInstField(x0M,x2H,x1F)),
		Rule(13, Value(0.990000, Token(13)), refStatField(x0M,x1F),MgetStatFldInst(x0M,x2V,x1F)),
		Rule(14, Value(0.113539, Token(14)), refStatField(x0M,x1F),modStatField(x0M,x1F)),
		Rule(15, Value(0.010000, Token(15)), refStatField(x0M,x1F),MputStatFldInst(x0M,x1F,x2V)),
		Rule(16, Value(0.105934, Token(16)), modStatField(x0M,x1F),rMM(x0M,x2M),refStatField(x2M,x1F)),
		Rule(17, Value(0.990000, Token(17)), modStatField(x0M,x1F),modStatField(x2M,x1F),rMM(x0M,x2M)),
		Rule(18, Value(0.010000, Token(18)), modStatField(x0M,x1F),refInstField(x0M,x2H,x1F)),
		Rule(19, Value(0.010000, Token(19)), modStatField(x0M,x1F),modInstField(x0M,x2H,x1F)),
		Rule(20, Value(0.010000, Token(20)), modStatField(x0M,x1F),MgetStatFldInst(x0M,x2V,x1F)),
		Rule(21, Value(0.010097, Token(21)), modStatField(x0M,x1F),refStatField(x0M,x1F)),
		Rule(22, Value(0.990000, Token(22)), modStatField(x0M,x1F),MputStatFldInst(x0M,x1F,x2V)),
		Rule(23, Value(0.010000, Token(23)), refInstField(x0M,x1H,x2F),MputInstFldInst(x0M,x3V,x2F,x4V),VH(x3V,x1H)),
		Rule(24, Value(0.010000, Token(24)), refInstField(x0M,x1H,x2F),modInstField(x0M,x1H,x2F)),
		Rule(25, Value(0.990000, Token(25)), refInstField(x0M,x1H,x2F),rMM(x0M,x3M),refInstField(x3M,x1H,x2F)),
		Rule(26, Value(0.990000, Token(26)), refInstField(x0M,x1H,x2F),MgetInstFldInst(x0M,x3V,x4V,x2F),VH(x4V,x1H)),
		Rule(27, Value(0.990000, Token(27)), modInstField(x0M,x1H,x2F),MputInstFldInst(x0M,x3V,x2F,x4V),VH(x3V,x1H)),
		Rule(28, Value(0.010000, Token(28)), modInstField(x0M,x1H,x2F),refInstField(x0M,x1H,x2F)),
		Rule(29, Value(0.990000, Token(29)), modInstField(x0M,x1H,x2F),modInstField(x3M,x1H,x2F),rMM(x0M,x3M)),
