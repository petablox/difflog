...
class AndersenPaperEx extends Problem {
  ...
  // val ptTuples: Set[DTuple] = Set((2, 4), (3, 5), (0, 2), (0, 3), (7, 2), (7, 3), (0, 6), (6, 2), (1, 6))
  val ptTuples: Set[DTuple] = Set((0, 2), (0, 3), (0, 6), (1, 2), (1, 3), (1, 6), (2, 4), (3, 5), (6, 4), (6, 5), (7, 4), (7, 5))
  ...
  override val soup: Set[Rule[FValue]] = Set(
    ...
    Rule(3, FValue(0.5, Token(3)), pt(x0, x1), load(x0, x1)),
    Rule(4, FValue(0.5, Token(4)), pt(x0, x1), store(x0, x1)),
    Rule(5, FValue(0.5, Token(5)), pt(x2, x1), pt(x0, x1), pt(x2, x0)),
    Rule(6, FValue(0.5, Token(6)), pt(x2, x1), addr(x2, x0), pt(x0, x1)),
    Rule(7, FValue(0.5, Token(7)), pt(x2, x1), assgn(x2, x0), pt(x0, x1)),
    Rule(8, FValue(0.5, Token(8)), pt(x2, x1), load(x2, x0), pt(x0, x1)),
    Rule(9, FValue(0.5, Token(9)), pt(x2, x1), pt(x0, x1), store(x2, x0)),
    Rule(10, FValue(0.5, Token(10)), pt(x2, x1), addr(x0, x1), pt(x2, x0)),
    Rule(11, FValue(0.5, Token(11)), pt(x2, x1), assgn(x0, x1), pt(x2, x0)),
    Rule(12, FValue(0.5, Token(12)), pt(x2, x1), load(x0, x1), pt(x2, x0)),
    Rule(13, FValue(0.5, Token(13)), pt(x2, x1), pt(x2, x0), store(x0, x1)),
    Rule(14, FValue(0.5, Token(14)), pt(x3, x1), pt(x0, x1), pt(x2, x0), pt(x3, x2)),
    Rule(15, FValue(0.5, Token(15)), pt(x3, x1), addr(x3, x2), pt(x0, x1), pt(x2, x0)),
    ...
    Rule(21, FValue(0.5, Token(21)), pt(x3, x1), load(x2, x0), pt(x0, x1), pt(x3, x2)),
    ...
    Rule(24, FValue(0.5, Token(24)), pt(x3, x1), addr(x0, x1), pt(x2, x0), pt(x3, x2)),
    Rule(25, FValue(0.5, Token(25)), pt(x3, x1), assgn(x0, x1), pt(x2, x0), pt(x3, x2)),
    Rule(26, FValue(0.5, Token(26)), pt(x3, x1), load(x0, x1), pt(x2, x0), pt(x3, x2)),
