...
@Ignore
class Genmodref_10 extends Problem {
	...
	val modInstFieldTuples = Set((1, 4, 3),(3, 4, 3),(4, 4, 3),(0, 1, 1),(0, 2, 5),(0, 4, 1),(0, 6, 7),(1, 0, 3),(1, 3, 3),(1, 4, 6),(1, 5, 1),(1, 6, 3),(1, 7, 0),(1, 7, 4),(2, 0, 5),(2, 1, 4),(2, 2, 4),(2, 2, 5),(2, 2, 7),(2, 3, 7),(2, 5, 2),(2, 7, 2),(3, 0, 6),(3, 1, 6),(3, 2, 5),(3, 2, 6),(3, 3, 5),(3, 4, 0),(4, 0, 1),(4, 0, 3),(4, 1, 1),(4, 1, 5),(4, 2, 7),(4, 3, 3),(4, 3, 7),(4, 5, 4),(4, 5, 7),(4, 7, 7),(5, 0, 1),(5, 1, 0),(5, 1, 2),(5, 1, 5),(5, 2, 1),(5, 5, 5),(5, 6, 3),(6, 0, 5),(6, 1, 0),(6, 3, 0),(6, 5, 6),(6, 6, 0),(6, 7, 5),(7, 2, 3),(7, 6, 4)).map { case (x0,x1,x2) => DTuple(Atom(x0),Atom(x1),Atom(x2)) }
	...
	val refStatFieldTuples = Set((1, 0),(2, 0),(4, 0),(5, 4),(7, 6),(1, 3),(1, 4),(2, 2),(3, 1),(3, 7),(7, 2)).map { case (x0,x1) => DTuple(Atom(x0),Atom(x1)) }
	val modStatFieldTuples = Set((0, 1),(1, 1),(2, 1),(3, 1),(4, 1),(6, 5),(7, 6),(0, 3),(3, 5),(6, 7)).map { case (x0,x1) => DTuple(Atom(x0),Atom(x1)) }
	val rMMTuples = Set((0, 1),(0, 2),(0, 4),(1, 2),(1, 3),(1, 4),(2, 3),(2, 4),(3, 4),(0, 5),(5, 1),(6, 0),(6, 2)).map { case (x0,x1) => DTuple(Atom(x0),Atom(x1)) }
	val refInstFieldTuples = Set((0, 2, 2),(1, 2, 2),(2, 2, 2),(3, 2, 2),(4, 2, 2),(0, 0, 1),(0, 1, 4),(0, 3, 1),(0, 3, 3),(0, 4, 3),(0, 4, 5),(0, 5, 1),(0, 5, 7),(1, 0, 4),(1, 4, 7),(1, 6, 2),(1, 6, 4),(1, 6, 5),(2, 1, 0),(2, 2, 5),(2, 3, 3),(2, 5, 0),(2, 7, 1),(2, 7, 7),(3, 0, 5),(3, 1, 6),(3, 2, 0),(3, 3, 4),(3, 4, 4),(3, 7, 1),(4, 2, 0),(4, 2, 3),(4, 3, 1),(4, 3, 3),(4, 6, 2),(4, 6, 4),(4, 7, 5),(5, 0, 0),(5, 2, 0),(5, 3, 0),(5, 5, 2),(5, 6, 2),(6, 2, 1),(6, 3, 2),(6, 5, 1),(6, 6, 4),(6, 6, 7),(7, 0, 4),(7, 1, 5),(7, 1, 6),(7, 1, 7),(7, 3, 5),(7, 4, 7),(7, 6, 2)).map { case (x0,x1,x2) => DTuple(Atom(x0),Atom(x1),Atom(x2)) }
