...
@Ignore
class Genanimals_10 extends Problem {
	...
	val fishTuples = Set(4,5,6,7,(0, 0),(0, 4),(0, 11),(0, 18),(0, 19),(1, 5),(1, 13),(1, 18),(3, 1),(3, 9),(3, 10),(4, 6),(5, 0),(5, 3),(5, 5),(5, 12),(6, 9),(7, 2),(7, 14),(8, 13),(9, 0),(9, 1),(10, 10),(10, 19),(11, 3),(11, 9),(11, 17),(12, 12),(13, 13),(13, 16),(15, 5),(15, 16),(16, 0),(17, 8),(17, 13),(17, 15),(17, 17),(17, 18),(17, 20),(18, 5),(18, 17),(19, 3),(19, 9),(19, 10),(20, 4),(20, 6),(20, 9),(20, 15),(20, 18)).map { case (x0) => DTuple(Atom(x0)) }
	...
	val mammalTuples = Set(0,1,2,3,7).map { case (x0) => DTuple(Atom(x0)) }
	val reptileTuples = Set(8,9,10,11,12,4,14,17).map { case (x0) => DTuple(Atom(x0)) }
	val birdTuples = Set(13,14,15,(0, 5),(0, 8),(1, 10),(1, 14),(1, 15),(1, 16),(2, 3),(3, 1),(3, 20),(4, 5),(5, 13),(5, 19),(6, 4),(6, 17),(8, 14),(9, 17),(10, 8),(10, 10),(10, 15),(10, 19),(11, 2),(11, 6),(11, 10),(11, 17),(12, 12),(13, 1),(13, 4),(13, 8),(14, 19),(15, 6),(16, 4),(16, 6),(16, 15),(17, 4),(17, 8),(17, 9),(18, 18),(19, 8),(19, 17)).map { case (x0) => DTuple(Atom(x0)) }
