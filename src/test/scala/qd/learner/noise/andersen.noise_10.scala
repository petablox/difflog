...
class Genandersen_10 extends Problem {
	...
	val ptTuples = Set((1, 2),(2, 3),(3, 5),(5, 6),(4, 2),(7, 5),(2, 6),(1, 1),(1, 7),(2, 0),(2, 1),(2, 4),(4, 4),(7, 0),(7, 4)).map { case (x0,x1) => DTuple(Atom(x0),Atom(x1)) }
